...
commitChange "Old MACDONALD had a farm" "commit 1" > /dev/null 2>&1
commitChange "E-I-E-I-O" "commit 2" > /dev/null 2>&1
commitChange "And on his farm he had a cow" "commit 3" > /dev/null 2>&1
commitChange "E-I-E-I-O" "commit 4" > /dev/null 2>&1
